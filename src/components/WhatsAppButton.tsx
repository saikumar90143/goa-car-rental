...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-6 right-4 sm:right-6 z-50 flex items-center justify-center gap-2 rounded-full bg-green-500 p-3 sm:px-4 sm:py-3 text-white shadow-xl shadow-green-500/30 hover:bg-green-600 transition-transform hover:scale-105"
      onClick={() => trackWhatsAppConversion()}
    >
      <svg className="w-7 h-7 sm:w-6 sm:h-6 flex-shrink-0" fill="currentColor" viewBox="0 0 448 512">
